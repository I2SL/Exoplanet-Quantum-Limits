% Computes the Quantum Chernoff Bound for Exoplanet Detection under optical
% axis alignment to the star-planet intensity centroid.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
b = 10.^-[3,3.5,4,5]';                      % relative brightness
