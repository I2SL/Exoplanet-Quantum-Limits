function [x,y] = UniformSpiralSampling(num_samples,num_turns,r0,th0)
    % uniform spiral sampling for a spiral that starts at (r0, th0)
    % goes through num_turns, and ends at radial distance 1.
    %
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %{
    % UNCOMMENT TO VISUALIZE SPIRAL SAMPLING LOCATIONS
